...
3. Make sure package.json you are running npm install for is inside the microservice folder.
...
7. I had to make sure to include my data folder inside my microservice folder. 
8. Once do
